...
plot_save_dir = os.path.join(RESULTS_SAVE_DIR, 'prediction_selected_plots_pedest_extrap/')
...
for t in [10,12,14,16,18,20,22,24]:
    if t==10:
        act_tmp=X_test[0,t]
        pred_tmp=X_hat[0,t]
...
im.save(plot_save_dir +  'plot_caltech_extrap' + str(start_img) + '-' + str(end_img) + '_fig.png')
