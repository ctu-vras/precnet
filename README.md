...
This repository contains complete code and trained models related to [PreCNet: Next Frame Video Prediction Basedon Predictive Coding] by Zdenek Straka, Tomas Svoboda and Matej Hoffmann. The content is sufficient to generate all results and figures from the paper.
