...
# Data files
train_file = os.path.join(DATA_DIR, 'X_bdd100k_train_40K.hkl')
train_sources = os.path.join(DATA_DIR, 'sources_bdd100k_train_40K.hkl')
...
#plt.show()
plt.savefig('training_curves_bdd_small')
