'''
Evaluate multiple frame prediction performance of trained PreCNet on Caltech Pedestrian Dataset sequences (Dollar et al. 2009, http://www.vision.caltech.edu/Image_Datasets/CaltechPedestrians/).
